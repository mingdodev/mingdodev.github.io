...
cf. 지금은 아래의 IAM Identify Center가 아니라 IAM으로 들어간다. Identify Center를 이용하여 IAM User를 생성하고 관리할 수도 있다.
...
옵션을 선택하여 콘솔에 대한 접근 권한을 부여할 수 있다. 앞서 등장했던 Identify Center를 이용하는 것을 권장하지만, 당장 필요하지 않으므로 사용자 생성만 해보겠다.  
